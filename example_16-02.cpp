...
int main() {
    ...
    Mat img1 = cv::imread("../box.png", CV_LOAD_IMAGE_COLOR);
    Mat img2 = cv::imread("../box_in_scene.png", CV_LOAD_IMAGE_COLOR);
    ...
    //surf fastfreak
    detect_and_compute("fastfreak", img1, kpts1, desc1);
    detect_and_compute("fastfreak", img2, kpts2, desc2);
