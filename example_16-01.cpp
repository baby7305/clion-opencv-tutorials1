...
int main() {
    ...
    // results.
    //
    cv::Mat imgA = cv::imread("../example_16-01-imgA.png", CV_LOAD_IMAGE_GRAYSCALE);
    cv::Mat imgB = cv::imread("../example_16-01-imgB.png", CV_LOAD_IMAGE_GRAYSCALE);
    cv::Size img_sz = imgA.size();
    int win_size = 10;
    cv::Mat imgC = cv::imread("../example_16-01-imgB.png", CV_LOAD_IMAGE_UNCHANGED);
