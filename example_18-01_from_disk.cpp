...
int main() {
    ...
    board_w = 12;
    board_h = 12;
    int n_boards = 28;  // how many boards max to read
    delay = 100;         // milisecond delay
    image_sf = 0.5;
    ...
    //C:\opencv\Learning-OpenCV-3_examples-master\calibration
    //C:\opencv\Learning-OpenCV-3_examples-master\stereoData
    string folder = "C:\\opencv\\Learning-OpenCV-3_examples-master\\calibration\\";
