...
//    }
    ...
    Size sz2Sh(300, 300);
    Mat img1 = imread("../shape_sample/1.png", IMREAD_GRAYSCALE);
    Mat img2 = imread("../shape_sample/3.png", IMREAD_GRAYSCALE);
    ...
    cout << "shape context distance between " <<
         "../shape_sample/1.png" << " and " << "../shape_sample/3.png" << " is: " << dis << endl;
