...
int main() {
    ...
    tmp = cv::imread("../HandIndoorColor.jpg");
    if (tmp.empty()) {
        cerr << "Error on reading image 1," << "../HandIndoorColor.jpg" << "\n" << endl;
        return (-1);
    }
    ...
    //
    src[2] = cv::imread("../HandOutdoorColor.jpg");
    src[3] = cv::imread("../HandOutdoorSunColor.jpg");
    src[4] = cv::imread("../fruits.jpg");
